...
page_order: 3
description: "This reference article covers our new Braze Postman Collection, what it is, how to set up and use the collection, as well as how to edit and send your requests."
page_type: reference
...
> Braze allows you to generate sample API requests for all of the endpoints through our Collection. This reference article covers the Braze Postman Collection, what it is, how to set up and use the collection, as well as how to edit and send requests.
...
If you have a Postman account (you can download macOS, Windows, and Linux types from the [Postman website][1]), you can open the Postman documentation in your own Postman app by clicking the orange **Run in Postman** button. You can then [create an environment](#setting-up-your-postman-environment), or use our Braze REST API environment as a template, and edit the available `POST` and `GET` requests to suit your own needs.
