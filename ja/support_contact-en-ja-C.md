...
var ticket_lookuptable = {
  'SelectText' : '何かお困りですか?',
  'Label': '* 私達は何をと助けることができるか。',
  'SelectDefault': 'トピックを選択...',
  'LinksTitle': ['マーケティング担当者向けドキュメント','開発者向けドキュメント','マーケティング担当者向けトラブルシューティングガイド','よくあるご質問'],
  ...
  'SelectOption': {
    'Technical Issue': {
      ...
      'LinksTitle': ['プラットフォームの機能'],
      'Links' : ['{{site.baseurl}}/developer_guide/platform_wide/platform_features/'],
      'SelectOption' : {
        'SDK Integrations' : {
          'Label': '私の質問は...*について',
          'SelectDefault': 'タイプを選択...',
          'LinksTitle': ['iOS：SDKの初期セットアップ','Android：SDKの初期セットアップ','Web:SDKの初期セットアップ','テストメッセージの'送信,'Brazeの学習コース:技術統合チェックリストとツールキット'],
          ...
          'SelectOption' : {
            'Push' : {
              ...
              'SelectOption' : {
                'Android' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['Android：プッシュ統合','Android：プッシュのトラブルシューティング'],
                ...
                'iOS' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['iOS：プッシュ統合', 'iOS：プッシュのトラブルシューティング'],
                ...
                'Web' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['Web:プッシュ統合','Web:エラーログ'],
                ...
                'Other' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['Braze開発者ガイド','SDKチェンジログ','テストメッセージの'送信,'Brazeの学習コース:技術統合チェックリストとツールキット'],
            ...
            'In-App Messages': {
              ...
              'Links':  [''],
              'Label': 'プラットフォーム *',
              'SelectDefault': 'データ型を選択...',
              'SelectOption' : {
                'Android' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['Android：アプリ内メッセージの統合','Android：アプリ内メッセージのカスタマイズ','Android：アプリ内メッセージのトラブルシューティング'],
                ...
                'iOS' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['iOS：アプリ内メッセージの統合','iOS：アプリ内メッセージのカスタマイズ','iOS：アプリ内メッセージのトラブルシューティング'],
                ...
                'Web' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['Web:アプリ内メッセージの統合','Web:アプリ内メッセージのカスタマイズ','Web:アプリ内メッセージのトラブルシューティング','Web:エラーログ'],
            ...
            'Content Cards': {
              ...
              'SelectOption' : {
                ...
                'Web' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['Web:コンテンツカードの統合','Web:コンテンツカードのカスタマイズ','Web:エラーログ'],
            ...
            'User Data' :{
              'ShowSubmit': false,
              'Label': 'カテゴリ *',
              'LinksTitle': ['自動的に収集されるデータ','イベントの命名規則','ユーザープロファイルライフサイクル'],
              'Links': ['{{site.baseurl}}/developer_guide/platform_wide/analytics_overview#automatically-collected-data','{{site.baseurl}}/user_guide/data_and_analytics/custom_data/event_naming_conventions/','{{site.baseurl}}/user_guide/data_and_analytics/user_data_collection/user_profile_lifecycle#user-profile-lifecycle'],
                ...
                'Custom Events, Purchase Event, and Properties' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['カスタムイベント','購入イベント','Android：カスタムイベントの'追跡,'iOS：カスタムイベントの'追跡,'Web:カスタムイベントのトラッキング'],
                ...
                'Custom Attributes' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['カスタム属性','Android：カスタム属性'を設定する,'iOS：カスタム属性'を設定する,'Web:カスタム属性を設定する'],
        ...
        'REST APIs' : {
          ...
          'SelectOption' : {
            ...
            'Exporting Data' : {
              'ShowSubmit': true,
              'LinksTitle': ['Brazeデータのエクスポート','REST API:エンドポイントのエクスポート', 'エクスポートに関するよくある質問'],
            ...
            'API Campaigns' : {
              'ShowSubmit': true,
              'LinksTitle': ['APIキャンペーンの概要','REST API:APIトリガーキャンペーンエンドポイント'の送信,'REST API:APIトリガーキャンペーンエンドポイントのスケジュール'],
            ...
            'Rate Limits' : {
              'ShowSubmit': true,
              'LinksTitle': ['APIのレート制限'],
               'Links' : ['{{site.baseurl}}/api/api_limits/']
             },
             'Other' : {
               'ShowSubmit': true,
               'LinksTitle': ['APIの基礎', 'APIの接続に関する問題','ポストマンとサンプルリクエスト'],
        ...
        'Email' : {
          'SelectDefault': 'タイプを選択...',
          'Label': '私の質問は...*について',
          'LinksTitle': ['Eメールのベストプラクティス','メールに関するよくある質問'],
          ...
          'SelectOption': {
            'Setup (whitelabeled IPs, DNS records)' : {
              'ShowSubmit': true,
              'LinksTitle': ['Eメールオンボーディングリソース','IPとドメイン'の設定,'IPウォーミング'],
            ...
            'Deliverability' :{
              'ShowSubmit': true,
              'LinksTitle': ['配信可能性の落とし穴とスパムトラップ','IPウォーミング','Brazeの学習コース:高いメール到達率の実現'],
            ...
            'Liquid' : {
              'ShowSubmit': true,
              'LinksTitle': ['メッセージ'内の液体の誘惑,'液体に関するよくある質問','Brazeの学習コース:Liquidによる動的なパーソナライゼーション'],
        ...
        'SMS and MMS' :{
          'SelectDefault': 'タイプを選択...',
          'Label': '私の質問は...*について',
          'LinksTitle': ['SMSのベストプラクティス','SMSに関するよくある質問', 'MMSに関するよくある質問', 'Brazeの学習コース:SMSの基礎'],
        ...
        'Campaigns and Canvas' :{
          ...
          'SelectOption': {
            ...
            'Targeting and Segmentation' : {
              'ShowSubmit': true,
              'LinksTitle': ['Segmentation','セグメントインサイト','Brazeの学習コース:Segmentation',''],
            ...
            'Message Composition by Channel' : {
              'LinksTitle': ['利用可能なチャネル','送信する前に知っておく:チャンネル'],
              ...
              'Label': 'チャンネル *',
              'SelectDefault': 'チャンネルを選択...',
              'SelectOption' : {
                'Email' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['ドラッグ＆ドロップエディタ'を使用した電子メールキャンペーンの作成,'HTMLエディタで電子メールキャンペーンを作成する'],
                ...
                'Push' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['プッシュキャンペーン'の作成,'Brazeの学習コース:プッシュ'],
                ...
                'In-App Messages' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['アプリ内メッセージドラッグアンドドロップエディタキャンペーン','アプリ内メッセージ従来のエディターキャンペーン','Brazeの学習コース:アプリ内メッセージとブラウザ内メッセージ'],
                ...
                'Content Cards' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['コンテンツカードキャンペーン'の作成,'Brazeの学習コース:コンテンツカード'],
                ...
                'WhatsApp' : {
                  'ShowSubmit': true,
                  'LinksTitle': ['WhatsAppキャンペーンを作成する'],
        ...
        'Technology Partners' :{
          ...
          'SelectOption': {
            'Message Personalization' : {
              'ShowSubmit': true,
              'LinksTitle': ['メッセージパーソナライゼーションパートナー'],
            ...
            'Data Infrastructure and Agility' : {
              'ShowSubmit': true,
              'LinksTitle': ['データおよびインフラストラクチャの俊敏性パートナー'],
              'Links' : ['{{site.baseurl}}/partners/data_and_infrastructure_agility']
            },
            'Other' : {
              'ShowSubmit': true,
              'LinksTitle': ['利用可能なパートナーとの連携'],
        ...
        'Other' :{
          ...
          'Label': '私の質問は...*について',
          'ShowSubmit': true,
          'LinksTitle': ['System Status','SDKの変更ログ'],
    ...
    'Strategy Assistance' : {
      'Label': '*カテゴリー',
      'SelectDefault': 'カテゴリを選択...',
      'LinksTitle': ['キャンペーンのアイデアと戦略','キャンバスのアイデアと戦略','Braze'でのアクセシブルなメッセージの構築,'Brazeの学習コース:キャンバスフローで顧客ジャーニーを作る'],
      ...
      'SelectOption' : {
        'Tools and Use Cases' : {
          'ShowSubmit': true,
          'LinksTitle': ['キャンペーンのアイデアと戦略', 'キャンバスのアイデアと戦略','Brazeの学習コース:カスタマーエンゲージメントツールとユースケース'],
